...
Use this checklist before running `rhis_installer.sh`.
...
Other runtime directories/files (for example `inventory/`, `host_vars/`, generated docs/runtime placeholders) are expected to be created by `rhis_installer.sh` when missing.
